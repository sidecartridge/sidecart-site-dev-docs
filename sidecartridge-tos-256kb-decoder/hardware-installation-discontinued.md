---
layout: default
title: Hardware Installation (Discontinued Versions)
nav_order: 3
nav_exclude: true
...
# Hardware Installation for Discontinued Versions
{: .no_toc }

This page documents the discontinued previous versions of the SidecarTridge TOS 256KB Decoder that were soldered directly to the Motorola 68000 CPU in Atari ST and Mega ST computers.

{: .warning}
This page is kept for reference only for older SidecarTridge TOS Emulator carrier board revisions and discontinued decoder versions. If you are installing the current Mega ST decoder with TOS Emulator carrier board revision 4 or higher, use the [current hardware installation guide](/sidecartridge-tos-256kb-decoder/hardware-installation/) instead.
...
[Current: Hardware Installation](/sidecartridge-tos-256kb-decoder/hardware-installation/){: .btn .mr-4 }
