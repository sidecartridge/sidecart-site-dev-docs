...
**Identifying A2000 motherboard revisions**
| Revision | Motherboard | Notable features |
|----------|-------------|------------------|
| rev4.2 and earlier | ![rev4.2](/sidecartridge-kickstart/assets/images/amiga2000-4.jpg) | Model label near Kickstart socket without PC jumper block; supports the rev4.2 carrier. |
| rev4.3 and later   | ![rev4.5](/sidecartridge-kickstart/assets/images/amiga2000-4-5.jpg) | Model label near Kickstart socket with revised silkscreen and jumper block; supports the rev4.3+ carrier. |
| rev6.2             | ![rev6.2](/sidecartridge-kickstart/assets/images/amiga2000-6-2.jpg) | Later A2000 boards with updated PSU connector layout; also use the rev4.3+ carrier. |
...
**Identifying A500 motherboard revisions**
| Revision  | Motherboard  | Notable Features |
|----------|------------------|------------------|
...
Once you have verified the compatibility of your Amiga 500 or Amiga 2000 motherboard, you can proceed to purchase the appropriate SidecarTridge Kickstart emulator kit. Ensure you select the correct kit based on your motherboard model number.
